...
const UserDashboardPage = () => {
    ...
    return (
        <Container className="py-3 text-center" style={{ minHeight: "100vh" }}>
            ...
            <div className="my-5">
                <Button onClick={displayForm} variant="success" className="my-2">Edit Profile Info</Button>
                <Button onClick={displayOrders} className="mx-4 my-2" variant="primary">View Orders</Button>
